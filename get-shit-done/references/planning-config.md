...
node /Users/rafaelfigueroa/.claude/get-shit-done/bin/gsd-tools.cjs commit "docs: update state" --files .planning/STATE.md

# Load config via state load (returns JSON):
INIT=$(node /Users/rafaelfigueroa/.claude/get-shit-done/bin/gsd-tools.cjs state load)
