...
```bash
INIT=$(node /Users/rafaelfigueroa/.claude/get-shit-done/bin/gsd-tools.cjs init milestone-op)
```
...
```bash
CHECKER_MODEL=$(node /Users/rafaelfigueroa/.claude/get-shit-done/bin/gsd-tools.cjs resolve-model gsd-integration-checker --raw)
```
...
node /Users/rafaelfigueroa/.claude/get-shit-done/bin/gsd-tools.cjs phases list
```
...
PHASE_INFO=$(node /Users/rafaelfigueroa/.claude/get-shit-done/bin/gsd-tools.cjs find-phase 01 --raw)
...
for summary in .planning/phases/*-*/*-SUMMARY.md; do
  node /Users/rafaelfigueroa/.claude/get-shit-done/bin/gsd-tools.cjs summary-extract "$summary" --fields requirements_completed | jq -r '.requirements_completed'
done
```
