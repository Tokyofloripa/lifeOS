...
```bash
INIT=$(node /Users/rafaelfigueroa/.claude/get-shit-done/bin/gsd-tools.cjs init quick "$DESCRIPTION")
```
...
```bash
node /Users/rafaelfigueroa/.claude/get-shit-done/bin/gsd-tools.cjs commit "docs(quick-${next_num}): ${DESCRIPTION}" --files ${file_list}
```
