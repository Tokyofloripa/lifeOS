...
if [ -f ./.claude/get-shit-done/VERSION ]; then
  ...
  echo "LOCAL"
elif [ -f /Users/rafaelfigueroa/.claude/get-shit-done/VERSION ]; then
  cat /Users/rafaelfigueroa/.claude/get-shit-done/VERSION
  echo "GLOBAL"
else
  echo "UNKNOWN"
fi
...
(Paths are relative to your install location: `/Users/rafaelfigueroa/.claude/` for global, `./.claude/` for local)
...
**If GLOBAL install:**
```bash
rm -f /Users/rafaelfigueroa/.claude/cache/gsd-update-check.json
```
