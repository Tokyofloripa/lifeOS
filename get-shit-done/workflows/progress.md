...
```bash
INIT=$(node /Users/rafaelfigueroa/.claude/get-shit-done/bin/gsd-tools.cjs init progress)
```
...
- `STATE=$(node /Users/rafaelfigueroa/.claude/get-shit-done/bin/gsd-tools.cjs state-snapshot)`
...
- Use `summary-extract` for efficient parsing:
  ```bash
  node /Users/rafaelfigueroa/.claude/get-shit-done/bin/gsd-tools.cjs summary-extract <path> --fields one_liner
  ```
...
PROGRESS_BAR=$(node /Users/rafaelfigueroa/.claude/get-shit-done/bin/gsd-tools.cjs progress bar --raw)
```
