...
```bash
TRANSITION=$(node /Users/rafaelfigueroa/.claude/get-shit-done/bin/gsd-tools.cjs phase complete "${current_phase}")
```
...
```bash
PROGRESS=$(node /Users/rafaelfigueroa/.claude/get-shit-done/bin/gsd-tools.cjs progress bar --raw)
```
...
```bash
node /Users/rafaelfigueroa/.claude/get-shit-done/bin/gsd-tools.cjs config-set workflow.auto_advance false
```
